...
function combinePorductHTMLItem(item) {
  ...
  <img
    ...
    alt=""
  />
  <a href="#" class="js-addCard" id="addCardBtn" data-id=${
    item.id
  }>加入購物車</a>
  <h3>${item.title}</h3>
...
function renderPorductList() {
  let str = "";
  productData.forEach(function (item) {
    str += combinePorductHTMLItem(item);
  });
